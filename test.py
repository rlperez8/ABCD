...
class Backtrader:
    ...
    def createCerebro(self, btFeed, strat, stockName, settings, pattern_A, pattern_AB, pattern_ABC, pattern_ABCD, full_scan, data_length):
    ...
    def runCerebro(self, stockDF, stockName, csvFilePath, settings, pattern_A, pattern_AB, pattern_ABC, pattern_ABCD, full_scan, data_length):


        btFeed = Backtrader().prepareDataForStrategy(stockDF, csvFilePath)
        

        Backtrader().createCerebro(btFeed, Three_Wave_Down_Trend, stockName, settings, pattern_A, pattern_AB, pattern_ABC, pattern_ABCD, full_scan, data_length)
...
class StrategyTools:
    ...
    def load_abcd_patterns(self, abcd_patterns):
        ...
        for each in abcd_patterns:
            ...
            abcds_sheet_1.append(abcd)
        df = pd.DataFrame(abcds_sheet_1)  

        print(df)
        DataBase().insert_data(df,'abcds_sheet_df')
    ...
    def isPivotAbnormalPriceJumpEngine(self,price_change_limit, pivot_length, current_candle_open, current_candle_close):
        
        # Call the get_average_size_of_bars_in_pivot function to calculate the average size of all bars in the pivot
        averageSizeOFBarsInPivot = StrategyTools().get_average_size_of_bars_in_pivot(pivot_length, current_candle_open, current_candle_close)
    ...
    def abnormalPriceJump(self, price_change_limit, pivot_length, current_candle_open, current_candle_close):
        ...
        if price_change_limit == "Off":
            ...
            abnormalPriceJump = StrategyTools().isPivotAbnormalPriceJumpEngine(price_change_limit, pivot_length, current_candle_open, current_candle_close)
...
class D:
    ...
    def get_d_to_a_retracement(
        ...
        if market == 'Bull':
            d_to_a_retracement = D().get_bull_d_to_a_retracement(candle_C_top, candle_A_top, candle_B_bot, low)
...
class Core:
    ...
    def check_for_pivot_A(
        ...
        try:
            ...
            pivotType = StrategyTools().findPivot('A',None, str(date(ago=-1)),data_close, data_open, pivot_length, market)

            if pivotType:
            
                isAbnormalPriceJump = StrategyTools().abnormalPriceJump(abnormal_price_jump,pivot_length, data_open, data_close)
                
                if isAbnormalPriceJump:

                    result, leftSideAverage, rightSideAverage = StrategyTools().checkPivotSideSteepness(
                        pivot_steepness[0],
                        data_open, 
                        data_close, 
                        pivot_length,  
    ...
    def check_for_pivot_B(
        ...
        try:
            for pivot_A in reversed(a_pivots):
                    ...
                    def remove_a():
                        pivot_A_top = StrategyTools().get_high_of_candle(pivot_A.pattern_A_open, pivot_A.pattern_A_close)
                        current_candle_top = StrategyTools().get_high_of_candle(data_open[0],data_close[0])
                    ...
                    if is_B_found:
                        ...
                        pattern_A_pivot_to_pattern_B_pivot_bar_length = StrategyTools().check_bar_length(date, pivot_A.pattern_A_pivot_date)
                        is_ab_correct = B().check_ab_is_start_of_abcd(market, pivot_A.pattern_A_low, data_low)

                        candle_A_low = StrategyTools().get_low_of_candle(pivot_A.pattern_A_open, pivot_A.pattern_A_close)
                        candle_A_high = StrategyTools().get_high_of_candle(pivot_A.pattern_A_open, pivot_A.pattern_A_close)
                        candle_B_low = StrategyTools().get_low_of_candle(pattern_B_open, pattern_B_close)
                        candle_B_high = StrategyTools().get_high_of_candle(pattern_B_open, pattern_B_close)
                        ...
                        if is_ab_correct:
                            ...
                            is_A_the_lowest = B().check_if_A_is_the_lowest(
                            ...
                            is_A_the_highest = B().check_if_A_is_the_highest(
                            ...
                            is_B_the_lowest = B().check_if_B_is_the_lowest(
                                pivot_A.pattern_AB_bar_duration, 
                                data_open, 
                                data_close, 
                                candle_B_low
                            ...
                            is_B_the_highest = B().check_if_B_is_the_highest(
                                pivot_A.pattern_AB_bar_duration, 
                                data_open, 
                                data_close, 
                                candle_B_high
                            ...
                            is_correct_shape = B().check_if_A_to_B_is_correct_shape(
                                market, 
                                is_A_the_highest, 
                                is_B_the_lowest, 
                                is_A_the_lowest,
        ...
        symbol,
            ...
            for pivotPairID, pivotPair in enumerate(reversed(ab_pivotPairs)):
                ...
                def remove_b():
                    ...
                    pivot_B_low = StrategyTools().get_low_of_candle(pivotPair.pattern_B_open, pivotPair.pattern_B_close)
                    current_candle_low = StrategyTools().get_low_of_candle(data_open[0],data_close[0])
                ...
                is_C_found = StrategyTools().findPivot(
                    'C',
                    pivotPair, 
                    str(date(ago=-1)), 
                    data_close, 
                ...
                if is_C_found:
                        ...
                        pattern_C_price_retracement = C().get_pattern_c_price_retracement(
                            settings,
                        ...
                        if C().check_if_c_is_the_high_and_if_b_is_the_low(
                            settings,
    ...
    def check_for_pivot_D(
        ...
        try:
            ...
            for pivotTrioID, pattern_ABC in enumerate(reversed(abc_pivotTrios)):
                    ...
                    def remove_c():
                        pivot_C_top = StrategyTools().get_high_of_candle(pattern_ABC.pattern_C_open, pattern_ABC.pattern_C_close)
                    ...
                    d_price_retracement = D().get_d_to_a_retracement(market,pattern_ABC,data_low,data_high)
                    ...
                    c_to_d_bar_length = StrategyTools().check_bar_length(date, pattern_ABC.pattern_C_pivot_date)
                    ...
                    c_position = D().get_c_position(market, c_to_d_bar_length, pattern_ABC, data_open, data_close)
                    d_position = D().get_d_position(market, c_to_d_bar_length, pattern_ABC, data_open, data_close)
        ...
        try:
            ...
            for abcdID, abcd in enumerate(pattern_abcd):
                ...
                if abcd.trade_created == False:
                    ...
                    abcd.trade_entered_price = StrategyTools().get_entry_price(market, data_low, data_high)
        ...
        try:
            for each in pattern_abcd:
                ...
                if each.trade_is_open == True and each.trade_is_closed == False:
                    ...
                    # print(each.trade_candle_ids, ids)
...
class Three_Wave_Down_Trend(bt.Strategy):
    ...
    def next(self) -> None:
        ...
        if self.full_scan:
            ...
            # self.counter, self.dateCanStart = StrategyTools().setDateTestingCanStart(self.counter, self.dateCanStart, self.settings['pivotLength'], self.datas[0].datetime)
      

            # if StrategyTools().preventPullingBarsFromBack(self.settings['barsFromBack'], str(self.datas[0].datetime.date(0)), self.dateCanStart):
