...
const buildFamilyStrategyRequestOptions = ({ sort = null, familyFilters = null } = {}) => ({
  ...
  strategy_three_month_trends: familyFilters?.threeMonthTrends ?? null,
  strategy_six_month_trends: familyFilters?.sixMonthTrends ?? null,
  strategy_twelve_month_trends: familyFilters?.twelveMonthTrends ?? null,
});
...
export const fetchStrategyTrades = async (
  ...
  const filter = {
    ...
    three_month_trend: strategy.threeMonthTrend,
    six_month_trend: strategy.sixMonthTrend,
    twelve_month_trend: strategy.twelveMonthTrend,
...
export const fetchSetupComparison = async ({
  ...
  const filter = {
    ...
    time_bin: timeBin,
    three_month_trend: threeMonthTrend,
